...
public class QuestData1_importer : AssetPostprocessor {
	private static readonly string filePath = "Assets/Resources/Data/QuestData1.xlsx";
	private static readonly string exportPath = "Assets/Resources/Data/QuestData1.asset";
		...
		foreach (string asset in importedAssets) {
			...
			using (FileStream stream = File.Open (filePath, FileMode.Open, FileAccess.Read, FileShare.ReadWrite)) {
				...
				foreach(string sheetName in sheetNames) {
					...
					cell = row.GetCell(4); p.time = (int)(cell == null ? 0 : cell.NumericCellValue);
