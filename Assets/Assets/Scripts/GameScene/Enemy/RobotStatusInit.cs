...
public class RobotStatusInit : MonoBehaviour
{
    EnemyStatus status;
    GameMasterScript gameMaster;
    public RobotData wData;
    AbilityList aList;
    ...
    int[] ability1 = new int[4] { 85, 107, 145, 178 };
    int[] ability2 = new int[4] { 86, 108, 146, 179 };
    ...
    void Start()
    {
        status.SetHP((int)wData.sheets[0].list[0].value + 420 * Lv);
        status.SetPower((int)wData.sheets[0].list[1].value + 14 * Lv);
