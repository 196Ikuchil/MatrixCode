...
public class CyclopsStatusInit : MonoBehaviour
{

    EnemyStatus status;
    GameMasterScript gameMaster;
    public CyclopsData wData;
    AbilityList aList;
    ...
    int[] ability1 = new int[5] { 75, 89, 95, 119, 181 };
    int[] ability2 = new int[6] { 76, 91, 96, 123, 181,187 };
    int[] ability3 = new int[10] { 76,87, 91, 96, 123,167, 170,181, 185,187 };
    ...
    void Start()
    {
        status.SetHP((int)wData.sheets[0].list[0].value + 450 * Lv);
